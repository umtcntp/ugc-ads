...
const ProjectCard = ({ gen, setGenerations, forCommunity = false }: projectCardProps) => {
        ...
        <div key={gen.id} className="mb-4 break-inside-avoid">
            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
                ...
                >
                    ...
                    {/* Actions Menu For My Generations */}
                    {!forCommunity && (
                        <div
                            onMouseUpCapture={() => setMenuOpen(true)}
                ...
                {/*Details*/}
                <div className="p-4">
                    {/*Prduct name, date, aspect ratio*/}
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex-1">
                            <h3 className="font-medium text-lg b-1">{gen.productName}</h3>
                    ...
                    {gen.productDescription && (
                        <div className="mt-3">
                            <p className="ext-xstext-gary-400 mb-1">Description</p>
