...
export default function Features() {
    ...
    return (
        <section id="features" className="py-20 2xl:py-32 scroll-mt-28">
            <div className="max-w-6xl mx-auto px-4">

                <Title
                    title="Features"
                    heading="Built for modern brands"
                    description="our AI instantly produces lifestyle 
                    imagery and short-form videos optimized for comercials & Reels."
                />
