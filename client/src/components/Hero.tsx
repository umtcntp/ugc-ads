...
export default function Hero() {
    ...
    const demoVideoUrl = "https://res.cloudinary.com/dy3xfxl4w/video/upload/ymd9agqzymaeqfy73isu.mp4";
    ...
    return (
        <>
            <section id="home" className="relative z-10 scroll-mt-28">
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and modal photo - our AI
                                instantly produces professional lifestyle imagery
                                and short-form videos optimized for commercials & Reels.
                            </motion.p>
                            ...
                            >
                                ...
                                <GhostButton onClick={() => setDemoOpen(true)} className="max-sm:w-full max-sm:justify-center py-3 px-5">
            ...
            {demoOpen && (
                ...
                >
                    <div
                        className="w-full max-w-4xl rounded-2xl overflow-hidden border border-white/10 bg-black"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
                            <span className="text-sm text-gray-200">Demo</span>
                            <button
