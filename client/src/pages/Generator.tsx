...
const Generator = () => {
    ...
    const handleGenerate = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!productName || !modelImage || !aspectRatio || !name || !productImage) return toast('Please fill the require fields')
        try {
    ...
    return (
        <div className="min-h-screen text-white p-6 md:p-12 mt-28">
            <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
                <Title heading="Create In-Conetxt Image"
                    ...
                    <div className="w-full">
                        ...
                        <div className="mb-4 text-gray-300">
                            <label
                                ...
                                className="block text-sm mb-4">
                                Product Description
                                <span className="text-xs text-violet-400 mb-4">(Optional)</span>
                            </label>
                            <textarea
                        ...
                        <div className="mb-4 text-gray-300">
                            ...
                            <textarea
                                ...
                                placeholder="Describe how you want the model to showcase the product"
                                className="w-full bg-white/3 rounded-lg border-2 p-4 
                                            text-sm border-violet-200/10 focus:border-violet-500/50 
                                            outline-none transition-all"
                            />
