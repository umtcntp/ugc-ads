                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="glass-panel inline-block p-2 rounded-2xl">
                            <div
                                className={`${project?.aspectRatio === "9:16" ? "aspect-9/16" : "aspect-video"} sm:max-w-200 rounded-xl bg-gray-900 overflow-hidden relative`}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
                            ...
                            {!project.generatedVideo ? (
                                ...
                                rounded-xl text-green-400 text-sm text-center font-medium">
                                    Video Generated Succesfully
                                </div>
                            )}
                        </div>
